		...
		<div id="list-video" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="person" title="${message(code: 'video.person.label', default: 'Author')}" />
